...
public class WorldScreen implements Screen {
    ...
    private void execute(Calabash[] bros, String step) {
        ...
        getMonsterByRank(matrix, Integer.parseInt(couple[0])).swap(getMonsterByRank(matrix, Integer.parseInt(couple[1])));
    }
    ...
    private Monster getMonsterByRank(Matrix matrix, int rank) {
        for(Monster monster:matrix.getAsList()){
